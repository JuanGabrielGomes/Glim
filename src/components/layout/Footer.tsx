...
export function Footer() {
  return (
    <footer className="bg-[#0b0908] px-4 pt-4 pb-8 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 border-t border-white/10 pt-6 text-sm text-white/55 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-col items-start gap-3 sm:items-end">
          <nav className="flex flex-wrap items-center gap-3 text-xs" aria-label="Rodapé">
            {NAV_ITEMS.map((item) => (
